    ...
    <div className={`flex flex-col last-of-type:mb-0 ` + className}>
      ...
      {isMulti ? (
        <div className="flex border items-center rounded-md bg-slate-50">
          <textarea
            className="flex-1 py-3 pl-4 border sm:border-0 rounded-md bg-slate-50 text-sm focus:outline-none w-full text-slate-600"
            cols={30}
            rows={props.rows}
            {...props}
          ></textarea>
        ...
        <div className="flex flex-col sm:flex-row items-end sm:items-center border-0 sm:border rounded-md bg-transparent sm:bg-slate-50">
          <input
            className="flex-1 py-3 pl-4 h-11 border sm:border-0 rounded-md bg-slate-50 text-sm focus:outline-none w-full text-slate-600"
            {...props}
          />
          {props.suffix ? (
